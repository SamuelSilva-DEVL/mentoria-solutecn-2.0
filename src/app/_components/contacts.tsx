...
export default function Contacts() {
  ...
  return (
    <section className="w-full h-full md:h-[550px] lg:h-[800px] 2xl:h-[950px] relative overflow-hidden bg-[#0f0f0f] md:bg-[#000000] text-[var(--text-primary-color-sn)] py-4">
      <div className="hidden md:block container mx-auto px-4 py-2 z-10 absolute left-[50%] top-[80px] md:top-[80px] lg:top-[100px] translate-x-[-50%] translate-y-[-50%]">
        <h2 className="w-2/3 m-auto text-[16px] lg:text-4xl font-bold text-center mb-16">
